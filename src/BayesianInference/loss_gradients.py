...
def expected_loss_gradients(posterior, n_samples, data_loader, dataset_name, device, mode, 
    model_idx, baseclass=None):
...
def main(args):
    ...
    n_inputs, n_samples_list, model_idx, dataset = 1000, [1, 10, 50, 100, 500], 2, "mnist"
